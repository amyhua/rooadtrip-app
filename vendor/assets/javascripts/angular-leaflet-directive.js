...
(function(angular) {
    ...
    angular.module("leaflet-directive")
        .service('leafletDirectiveControlsHelpers', ["$log", "leafletData", "leafletHelpers",
    ...
    angular.module("leaflet-directive").factory('leafletEvents', ["leafletMapEvents", "leafletMarkerEvents", "leafletPathEvents",
    ...
    angular.module("leaflet-directive")
        .service('leafletGeoJsonHelpers', ["leafletHelpers", "leafletIterators",
    ...
    angular.module('leaflet-directive').service('leafletIterators', ["$log", "leafletHelpers",
        function($log, leafletHelpers) {
    ...
    angular.module("leaflet-directive")
        .factory('leafletLayerHelpers', ["$rootScope", "$log", "leafletHelpers",
    ...
    angular.module("leaflet-directive")
        .service('leafletMarkersHelpers', ["$rootScope", "leafletHelpers", "$log", "$compile", "leafletGeoJsonHelpers",
  ...
  */
    ...
    angular.module("leaflet-directive")
    // .directive('geojson', ["$log", "$rootScope", "leafletData", "leafletHelpers", "leafletWatchHelpers", "leafletDirectiveControlsHelpers", "leafletIterators",
    ...
    angular.module("leaflet-directive").directive('markers', ["$log", "$rootScope", "$q", "leafletData", "leafletHelpers", "leafletMapDefaults", "leafletMarkersHelpers", "leafletEvents", "leafletIterators", "leafletWatchHelpers", "leafletDirectiveControlsHelpers",
    ...
    angular.module("leaflet-directive").directive('maxbounds', ["$log", "leafletMapDefaults", "leafletBoundsHelpers", "leafletHelpers",
...
*/
    ...
    angular.module("leaflet-directive")
        .factory('leafletEventsHelpers', ["$rootScope", "$q", "$log", "leafletHelpers",
    ...
    angular.module("leaflet-directive")
        .factory('leafletLabelEvents', ["$rootScope", "$q", "$log", "leafletHelpers", "leafletEventsHelpers",
            function($rootScope, $q, $log, leafletHelpers, leafletEventsHelpers) {
                var Helpers = leafletHelpers,
    ...
    angular.module("leaflet-directive")
        .factory('leafletMapEvents', ["$rootScope", "$q", "$log", "leafletHelpers", "leafletEventsHelpers",
            function($rootScope, $q, $log, leafletHelpers, leafletEventsHelpers) {
                var safeApply = leafletHelpers.safeApply,
                    isDefined = leafletHelpers.isDefined,
                    isObject = leafletHelpers.isObject,
    ...
    angular.module("leaflet-directive")
        .factory('leafletMarkerEvents', ["$rootScope", "$q", "$log", "leafletHelpers", "leafletEventsHelpers", "leafletLabelEvents",
            function($rootScope, $q, $log, leafletHelpers, leafletEventsHelpers, leafletLabelEvents) {
                var safeApply = leafletHelpers.safeApply,
                    isDefined = leafletHelpers.isDefined,
                    isObject = leafletHelpers.isObject,
                    Helpers = leafletHelpers,
    ...
    angular.module("leaflet-directive")
        .factory('leafletPathEvents', ["$rootScope", "$q", "$log", "leafletHelpers", "leafletLabelEvents", "leafletEventsHelpers",
