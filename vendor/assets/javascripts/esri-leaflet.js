...
(function(factory) {
  ...
  function(a) {
    ...
    a.Util.extentToBounds = function(a) {
      ...
      return b
    }, a.Util.requestAnimationFrame = L.Util.bind(m, window)
  }(EsriLeaflet),
  function(a) {
    function b(a) {
      var b = "";
    ...
    window._EsriLeafletCallbacks = {}, a.Request = {
      request: function(a, d, e, f) {
        var g = b(d),
          h = c(e, f),
          i = (a + "?" + g).length;
        if (2e3 >= i && L.esri.Support.CORS) h.open("GET", a + "?" + g), h.send(null);
        else if (i > 2e3 && L.esri.Support.CORS) h.open("POST", a), h.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), h.send(g);
        else {
          if (2e3 >= i && !L.esri.Support.CORS) return L.esri.Request.get.JSONP(a, d, e, f);
          if (console && console.warn) return void console.warn("a request to " + a + " was longer then 2000 characters and this browser cannot make a cross-domain post request. Please use a proxy http://esri.github.io/esri-leaflet/api-reference/request.html")
        }
        return h
      },
      post: {
  ...
  }), EsriLeaflet.Services.featureLayer = function(a) {
    return new EsriLeaflet.Services.FeatureLayer(a)
    ...
    where: function(a) {
      return this.params.where = a.replace(/"/g, "'"), this
    },
  ...
  function(a) {
    ...
    _renderImage: function(a, b) {
      if (this._map) {
        ...
        c.once("load", function(a) {
          ...
          c._bounds.equals(b) ? (this._currentImage = c, "front" === this.options.position ? this.bringToFront() : this.bringToBack(), this._map && this._currentImage._map ? this._currentImage.setOpacity(this.options.opacity) : this._currentImage._map.removeLayer(this._currentImage), d && this._map && this._map.removeLayer(d), d && d._map && d._map.removeLayer(d)) : this._map.removeLayer(c), this.fire("load", {
            bounds: b
          })
    ...
    initialize: function(a, b) {
      b = b || {}, b.url = EsriLeaflet.Util.cleanUrl(a), this._service = new EsriLeaflet.Services.MapService(b), this._service.on("authenticationrequired requeststart requestend requesterror requestsuccess", this._propagateEvent, this), b.proxy && (b.f = "json"), L.Util.setOptions(this, b)
    },
    getLayers: function() {
    ...
    _getPopupData: function(a) {
      ...
      c.layers(this.options.layers ? "visible:" + this.options.layers.join(",") : "visible"), c.run(b), this._shouldRenderPopup = !0, this._lastClick = a.latlng
    },
  ...
  }), EsriLeaflet.DynamicMapLayer = EsriLeaflet.Layers.DynamicMapLayer, EsriLeaflet.Layers.dynamicMapLayer = function(a, b) {
    ...
    initialize: function(a, b) {
      b = b || {}, b.url = EsriLeaflet.Util.cleanUrl(a), this._service = new EsriLeaflet.Services.ImageService(b), this._service.on("authenticationrequired requeststart requestend requesterror requestsuccess", this._propagateEvent, this), L.Util.setOptions(this, b)
    },
    ...
    setBandIds: function(a) {
      return this.options.bandIds = L.Util.isArray(a) ? a.join(",") : a.toString(), this._update(), this
    },
    getBandIds: function() {
      return this.options.bandIds
    },
    setNoData: function(a, b) {
      return this.options.noData = L.Util.isArray(a) ? a.join(",") : a.toString(), b && (this.options.noDataInterpretation = b), this._update(), this
    },
    getNoData: function() {
  ...
  }), EsriLeaflet.ImageMapLayer = EsriLeaflet.Layers.ImageMapLayer, EsriLeaflet.Layers.imageMapLayer = function(a, b) {
  ...
  function(a) {
    ...
    a.Layers.FeatureManager = a.Layers.FeatureGrid.extend({
      ...
      initialize: function(c, d) {
        if (a.Layers.FeatureGrid.prototype.initialize.call(this, d), d = d || {}, d.url = a.Util.cleanUrl(c), d = L.setOptions(this, d), this._service = new a.Services.FeatureLayer(d), "*" !== this.options.fields[0]) {
      ...
      _requestFeatures: function(b, c, d) {
        return this._activeRequests++, 1 === this._activeRequests && this.fire("loading", {
          ...
          g && g.exceededTransferLimit && this.fire("drawlimitexceeded"), this._activeRequests--, !e && f.features.length && a.Util.requestAnimationFrame(L.Util.bind(function() {
            this._addFeatures(f.features, c)
          }, this)), d && d.call(this, e, f), this._activeRequests <= 0 && this.fire("load", {
            bounds: b
          })
        }, this)
      },
      ...
      setWhere: function(b, c, d) {
        ...
        for (var e = [], f = [], g = 0, h = null, i = L.Util.bind(function(b, i) {
          ...
          g--, 0 >= g && (this._currentSnapshot = f, a.Util.requestAnimationFrame(L.Util.bind(function() {
    ...
    initialize: function(a, b) {
      EsriLeaflet.Layers.FeatureManager.prototype.initialize.call(this, a, b), b = L.setOptions(this, b), this._layers = {}, this._leafletIds = {}, this._key = "c" + (1e9 * Math.random()).toString(36).replace(".", "_")
    },
    onAdd: function(a) {
    ...
    setFeatureStyle: function(a, b) {
      ...
      if ("function" == typeof b) b = b(c.feature);
      else if (!b && !c.defaultOptions) {
        {
          new L.Path
        }
        b = L.Path.prototype.options, b.fill = !0
      }
  ...
  }), EsriLeaflet.FeatureLayer = EsriLeaflet.Layers.FeatureLayer, EsriLeaflet.Layers.featureLayer = function(a, b) {
    ...
    onAdd: function() {
      ...
      return a.style.marginTop = this.options.marginTop, a.style.marginLeft = this.options.marginLeft, a.style.marginBottom = this.options.marginBottom, a.style.marginRight = this.options.marginRight, a.innerHTML = '<a href="https://developers.arcgis.com" style="border: none;"><img src="https://js.arcgis.com/3.11/esri/images/map/logo-med.png" style="border: none;"></a>', a
    }
